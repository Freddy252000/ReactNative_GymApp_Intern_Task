...
|------|----------|----------|-----------|
| (./src/assets/screenshots/WelcomeScreen.png) | (./src/assets/screenshots/LoginScreen.png)  | (./src/assets/screenshots/HomeScreen.png) |  (./src/assets/screenshots/WorkOut.png) | (./src/assets/screenshots/Progress.png) | (./src/assets/screenshots/Progress.png) |  (./src/assets/screenshots/DarkModeProfile.png) | (./src/assets/screenshots/DarkMode%20Home.png) |
